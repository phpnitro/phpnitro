...
let package = Package(
    ...
    targets: [
        ...
        // identical — same idiom as the 2 bundled fonts above) via a
        // hand-written module map, so RustNativeRenderer below can
        // `import CPhpNitroRender` and call its C functions directly —
