...
4. ~~Aucun overlay pour TextField~~ — corrigé (voir plus haut). VideoPlayer/MapView/Lottie restent sans overlay — le pendant de `rootLayout.addView(...)` dans `NativeRenderPocActivity.kt` pour ceux-là spécifiquement, pas encore attaqué.
