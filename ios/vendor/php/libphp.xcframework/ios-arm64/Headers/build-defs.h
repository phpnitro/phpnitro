...
#define CONFIGURE_COMMAND " './configure'  '--host=aarch64-apple-darwin' '--disable-all' '--without-pear' '--disable-cli' '--disable-cgi' '--disable-phpdbg' '--without-pcre-jit' '--enable-session=static' '--enable-pdo=static' '--with-pdo-sqlite=static' '--with-sqlite3=static' '--enable-embed=static' 'host_alias=aarch64-apple-darwin' 'SQLITE_CFLAGS=-I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk/usr/include' 'SQLITE_LIBS=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.5.sdk/usr/lib -lsqlite3'"
