...
public final class RustScreenController {
    ...
    private func handle(action: String) {
        ...
        case .clientTabOnly:
            // No client-side tab-switch state kept in this minimal shell
            // yet — same "not yet interactive" scoping the Rust engine's
            // own clientPanel painting currently has (see
            // rust/phpnitro-render/src/raster.rs).
            break
