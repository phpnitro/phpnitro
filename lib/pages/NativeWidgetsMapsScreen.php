 ...
 * org.osmdroid.views.MapView (MapView, overlaid at the tapped rect —
...
final class NativeWidgetsMapsScreen
{
    public static function build(float $screenWidth, float $screenHeight): Widget
    {
            ...
            new Padding(
                ...
                Flex::column([
                    ...
                    new Padding(
                        ...
                        new MapView($lat, $lon, $zoom, $contentWidth),
                    ),
        ...
        return new Scaffold(
            ...
            $screenWidth,
            $screenHeight,
            appBar: new AppBar($screenWidth, 'Cartes', backAction: 'back'),
        );
    }
}
