...
# /api itself is generated by the earlier "make:page Home /" call (route ""
# -> apiRoute "/api"), not a built-in endpoint a fresh scaffold ships on its
# own — a project with no pages yet has no backend routes either.
